...
function sortFile(inputFile, outputFile, inputMapFn = x => x, outputMapFn = x => String(x), compareFn = (a, b) => a > b ? 1 : -1, inputDelimeter = '\n', outputDelimeter = '\n', linesPerFile = 100000) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield mergeSortedFiles(tempFiles, outputStream, JSON.parse, outputMapFn, compareFn, outputDelimeter);
            outputStream.close();
        }
        finally {
 ...
 *                                        created and temporary files has been cleaned up.
 */
function sortStream(inputStream, outputStream, inputMapFn = x => x, outputMapFn = x => String(x), compareFn = (a, b) => a > b ? 1 : -1, delimeter = '\n', linesPerFile = 100000) {
    return __awaiter(this, void 0, void 0, function* () {
        const base = path.join(os.tmpdir(), 'large-sort');
        if (!fs.existsSync(base)) {
            fs.mkdirSync(base, { recursive: true });
